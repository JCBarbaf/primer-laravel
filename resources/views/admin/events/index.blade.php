...
@section('data-list')
    <header>
        <p>{{trans_choice('admin/pagination.total',  2, ['count' => 2])}}</p>
...
@section('data-add')
    <div class="add-header">
        <div class="tabs">
            ...
            <div class="tab" data-field="sponsors">
    ...
    <form>
        ...
        <div class="tab-content" data-field="sponsors">
            <div class="form-row">
                <div class="form-field">
